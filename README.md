...
```javascript
variancepn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancepn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-variancepn/tags). For example,

```javascript
variancepn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancepn@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var variancepn = require( 'path/to/vendor/umd/stats-base-variancepn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancepn@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-variancepn/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-variancepn/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/stats-base-variancepn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-variancepn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-variancepn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-variancepn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-variancepn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-variancepn/blob/main/branches.md
