...
```javascript
variancepn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancepn@v0.0.10-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-variancepn@v0.0.10-umd/browser.js"></script>
```
